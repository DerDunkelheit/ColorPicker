...
namespace Walnut {
	...
	void Application::Init()
	{
		...
		{
				ApplicationSpecification& data = *static_cast<ApplicationSpecification*>(glfwGetWindowUserPointer(window));
				switch (action)
				{
					case GLFW_PRESS:
						{
		...
		if (!m_Specification.ParentWindow) io.ConfigViewportsNoAutoMerge = true;
